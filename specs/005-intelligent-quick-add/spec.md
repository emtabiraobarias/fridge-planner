...
- **Existing vocabularies are unchanged**: the current category, location, and unit sets stay as they are; this feature maps free text onto them and adds no new enum values.
