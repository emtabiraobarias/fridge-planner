import type { IInventoryItem } from '../models/inventory-item.js';
import type { IMealPlan } from '../types/meal-plan.js';
import type { IGroceryListItem, GroceryCategory } from '../types/grocery-list.js';
import { GROCERY_CATEGORIES } from '../types/grocery-list.js';
import { normalizeIngredientName, matchIngredients } from './ingredient-matcher.js';
import { inferCategory } from './ingredient-categorizer.js';
import { canSubtract, netNeeded } from './unit-normalizer.js';
