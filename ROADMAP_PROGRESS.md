...
|---|---|---|---|
| B — Verify | ☐ not started | ◐ inventory + recommendations done (2026-06-08/11); 6 bugs, 2 spec-gaps | scenario checklist + spec-gap register |
